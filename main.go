...
import (
	...
	"gitlab.trendyol.com/platform/base/apps/ratelimit-operator/controllers"
...
func init() {
	...
	utilruntime.Must(trendyolcomv1beta1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a1f6a19e.trendyol.com",
	})
	if err != nil {
